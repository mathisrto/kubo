...
export const DashboardNavbar = () => {
  ...
  const updateEnvironmentMapF = async (formData: FormData) => {
    ...
    try {
      ...
      logger.error("Error updating environment map:", error);
    }
  };
    ...
    <header className="fixed top-0 z-30 border-b bg-background backdrop-blur-sm w-full">
      <div className="mx-auto flex h-16 items-center justify-between px-4">
        <div className="flex items-center gap-4">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              ...
              >
                <span className="font-semibold">{t("scene")}</span>
              </Button>
            </DropdownMenuTrigger>
                ...
                <DropdownMenuSubContent className="w-64 p-3">
                  <div className="space-y-3">
                    <div>
                      ...
                      <Select
                        onValueChange={(value) => {
                          updateCameraType(world, value as CameraType);
                        }}
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value={CameraType.PERSPECTIVE}>
                            {t("camera_perspective")}
                          </SelectItem>
                          <SelectItem value={CameraType.ORTHOGRAPHIC}>
                    ...
                    <div>
                      <Label className="text-xs mb-1 block">
                        {t("camera_fov")}: {getCameraFOV(snap)}°
                      </Label>
                      <input
                        type="range"
                        min={10}
                        ...
                        onChange={(e) =>
                          updateCameraFOV(world, parseFloat(e.target.value))
                        }
                    ...
                    <div>
                      <Label className="text-xs mb-1 block">
                        {t("camera_near")}: {getCameraNear(snap)}
                      </Label>
                      <input
                        type="range"
                        min={0.1}
                        ...
                        onChange={(e) =>
                          updateCameraNear(world, parseFloat(e.target.value))
                        }
                        className="w-full h-2"
                      />
                    </div>
                    <div>
                      <Label className="text-xs mb-1 block">
                        {t("camera_far")}: {getCameraFar(snap)}
                      </Label>
                      <input
                        type="range"
                        min={100}
                        ...
                        onChange={(e) =>
                          updateCameraFar(world, parseFloat(e.target.value))
                        }
                        className="w-full h-2"
                      />
                    </div>
                  ...
                  <div className="space-y-3">
                    <div>
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={handleEnvironmentImageChange}
                        className="w-full"
                      >
                      ...
                      <form
                        ...
                        action={async (formData) => {
                          await updateEnvironmentMapF(formData);
                        }}
                      >
                        <input
                          ref={fileInputRef}
                    ...
                    <div>
                      <Label className="text-xs mb-1 block">
                        ...
                        {getEnvironmentIntensity(snap).toFixed(1)}
                      </Label>
                      <input
                        type="range"
                        min={0}
        ...
        <div className="flex justify-center items-center">
          ...
          <Button variant="ghost" className="ml-6" onClick={handleLogout}>
            <LogOutIcon />
